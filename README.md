...
<html lang="en">
  ...
  <body>
    ...
    <!-- Optional analytics is injected at runtime by client/src/lib/analytics.ts
         when VITE_ANALYTICS_ENDPOINT and VITE_ANALYTICS_WEBSITE_ID are set. -->
  </body>
...
- Vite is pinned to 5.x so the configured Vite plugins have compatible peer dependency ranges.
- Analytics is loaded conditionally at runtime and is skipped when analytics environment variables are not provided.
